...
--	SKIN:Bang('!Log', table.concat(rgb, ','), 'Debug')
	...
	if greyscale == false then 
		...
		SKIN:Bang('!SetVariable', 'palette1', HSVtoRGB(Hue, 0, ((1 - maxVal) * 0.75 + maxVal)))
		SKIN:Bang('!SetVariable', 'palette2', HSVtoRGB(Hue, 0, ((1 - maxVal) * 0.666 + maxVal)))
		SKIN:Bang('!SetVariable', 'palette3', HSVtoRGB(Hue, 0, ((1 - maxVal) * 0.333 + maxVal)))
		SKIN:Bang('!SetVariable', 'palette4', HSVtoRGB(Hue, 0, maxVal))
		SKIN:Bang('!SetVariable', 'palette5', HSVtoRGB(Hue, 0, (maxVal * 0.666)))
		SKIN:Bang('!SetVariable', 'palette6', HSVtoRGB(Hue, 0, (maxVal * 0.333)))
		SKIN:Bang('!SetVariable', 'palette7', HSVtoRGB(Hue, 0, (maxVal * 0.25)))
	end
end